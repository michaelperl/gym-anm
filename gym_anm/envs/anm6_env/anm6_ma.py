...
from ..multi_agent_anm_env import MA_ANMEnv
from .rendering.py import rendering
from .network import network
from .utils import random_date

class ANM6_MA(MA_ANMEnv):
    """
    ...
    def __init__(self, K, delta_t, gamma, lamb, agents,
                     aux_bounds=None, costs_clipping=None, seed=None):

        super().__init__(network, K, delta_t, gamma, lamb, agents,
    ...
    def step(self, action_n):
        obs_n, r_n, done, info = super().step(action_n)
